...
const binary_relation_index_1 = __importDefault(require("../models/binary_relation_index"));
...
class Hexo extends events_1.EventEmitter {
    constructor(base = process.cwd(), args = {}) {
        ...
        this._binaryRelationIndex = {
            post_tag: new binary_relation_index_1.default('post_id', 'tag_id', 'PostTag', this),
            post_category: new binary_relation_index_1.default('post_id', 'category_id', 'PostCategory', this)
        };
    }
    _bindLocals() {
