...
function parseArgs(args) {
    const matches = [];
    let match, language_attr, line_number, line_threshold, wrap;
...
module.exports = (ctx) => {
    return function backtickCodeBlock(data) {
        ...
        if ((!dataContent.includes('```') && !dataContent.includes('~~~')) || !ctx.extend.highlight.query(ctx.config.syntax_highlighter))
            return;
...
//# sourceMappingURL=backtick_code_block.js.map